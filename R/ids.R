#' Build a search URL for French heritage IDs
#'
#' This internal helper constructs a URL to query the French heritage
#' RSS search service, filtered by a bounding box (`extent`) and
#' a department code (`insee_dep`). The URL is routed through the
#' Atlas IGN proxy.
#'
...
#'
#' @return A character string containing the full URL to query the RSS service.
#'
#' @keywords internal
#'
...
#' Perform the request URL for the "Atlas du Patrimoine" RSS service
#'
...
#' Ministry of Culture's GeoSource RSS service. It includes a retry mechanism
...
##' Parse the response from the "Atlas du Patrimoine" RSS service
#'
...
#' Map heritage descriptions to standard heritage codes
#'
#' This internal function converts textual descriptions of heritage items
#' into their corresponding internal codes (e.g., "IMMH", "PAMH").
#' It matches based on predefined keyword patterns and chooses the most
#' specific code when multiple patterns match.
#'
#' @param x Character vector of heritage descriptions.
#'
#' @return Character vector of codes corresponding to each input description.
...
#' Fetch heritage items from a given Atlas URL
#'
